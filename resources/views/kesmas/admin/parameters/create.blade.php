...
<div class="card">
    <h3 style="font-size:20px;font-weight:600;margin-bottom:14px;">Tambah Parameter Pemeriksaan</h3>
    ...
    <form method="POST" action="{{ route('admin.kesmas.parameters.store') }}">
        @csrf
        ...
        <div style="display:grid;gap:14px;">
            ...
            <div>
                ...
                <select name="kategori" id="kategori" required
                    ...
                    <option value="mikrobiologi" {{ old('kategori')=='mikrobiologi' ? 'selected' : '' }}>Mikrobiologi</option>
            ...
            <div>
                ...
                <input type="text"
                       name="nama_parameter"
                       required
                       value="{{ old('nama_parameter') }}"
                       placeholder="Isi nama parameter, misal: Air Bersih"
                       style="width:100%;padding:8px;border-radius:10px;border:1px solid #d1d5db;">
